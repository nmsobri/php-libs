...
class ValidatorTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $mockValidatorStrategy = $this->getMockForAbstractClass( 'utility\validator\ValidatorStrategy' );
    ...
    {
        $checkbox_validator = new utility\validator\CheckBoxValidator( $name, $value, $attr );
    ...
    {
        $compare_validator = new utility\validator\CompareValidator( $name, $value, $comparison_value, $comparison_field, $attr );
    ...
    {
        $compare_validator = new utility\validator\CompareValidator( $name, $value, $comparison_value, $comparison_field );
    ...
    {
        $date_validator = new utility\validator\DateValidator( $name, $value, $attr );
    ...
    {
        $email_validator = new utility\validator\EmailValidator( $name, $value, $attr );
    ...
    {
        $number_validator = new utility\validator\NumberValidator( $name, $value, $attr );
    ...
    {
        $radio_validator = new utility\validator\RadioValidator( $name, $value, $attr );
    ...
    {
        $regex_validator = new utility\validator\RegexValidator( $name, $value, $regex, $attr );
    ...
    {
        $file_validator = new utility\validator\FileValidator( $name, $file, $ext, $attr );
    ...
    {
        $select_validator = new utility\validator\SelectValidator( $name, $value, $attr );
    ...
    {
        $text_validator = new utility\validator\TextValidator( $name, $value, $attr );
    ...
    public function testErrorValidatorExptectedToSetupPropertyProperly()
    {
        ...
        $error_validator = new utility\validator\ErrorValidator( $msg );
    ...
    {
        $error_validator = new utility\validator\ErrorValidator( 'validation failed' );
    ...
    public function testAddValidatorReturnsExpectedObject()
    {
        ...
        $text_validator = new utility\validator\TextValidator( 'username', 'slier' );
        $validator = new utility\Validator();
    ...
    public function testInvalidateFieldReturnsExpectedResult()
    {
        ...
        $validator = new utility\Validator();
        $text_validator = new utility\validator\TextValidator( 'user', 'slier' );
    ...
    public function dataProvidertestIsValidReturnsExpectedResult()
    {
        ...
        return array(
            ...
            array( array( new utility\validator\TextValidator( 'name', 'sobri' ) ), true ),
            array( array( new utility\validator\TextValidator( 'name', 'sobri' ), new utility\validator\NumberValidator( 'position', '123' ) ), true ),
            array( array( new utility\validator\NumberValidator( 'position', '123.00' ) ), false ),
            array( array( new utility\validator\NumberValidator( 'position', '123.00' ), new utility\validator\TextValidator( 'name', 'sobri' ) ), false ),
            array( array( new utility\validator\TextValidator( 'name', 'sobri ' ) ), false )
    ...
    public function dataProvidertestIsErrorReturnsExpectedResult()
    {
        ...
        return array(
            ...
            array( function () {
                ...
                $validator = new utility\Validator();
                $validator->addValidator( 'name', new utility\validator\TextValidator( 'name', 'sobri' ) );
                $validator->addValidator( 'position', new utility\validator\NumberValidator( 'position', '123' ) );
                $validator->isValid();
                return $validator->isError();
            }, false ),
            ...
            array( function () {
                ...
                $validator = new utility\Validator();
                $validator->addValidator( 'name', new utility\validator\TextValidator( 'name', 'sobri' ) );
                $validator->addValidator( 'position', new utility\validator\NumberValidator( 'position', 'adsf' ) );
                $validator->isValid();
                return $validator->isError();
            }, true ),
    ...
    public function dataProvidertestGetErrorReturnsExpectedErorMsg()
    {
        ...
        return array(
            ...
            array( function () {
                ...
                $validator = new utility\Validator();
                $validator->addValidator( 'user', new utility\validator\TextValidator( 'user', '' ) );
                $validator->isValid();
            ...
            array( function () {
                ...
                $validator = new utility\Validator();
                $validator->addValidator( 'user', new utility\validator\TextValidator( 'user', 'slier9' ) );
                $validator->isValid();
                return $validator->getError( 'user' );
    ...
    public function dataProvidertestGetAllErrorReturnsExptectedValue()
    {
        ...
        return array(
            ...
            array( new utility\validator\TextValidator( 'user', 'slier' ), null ),
            array( array( 'user' => new utility\validator\TextValidator( 'user', '123' ) ), array( 'user' => 'Field user contains error.Only text are allowed' ) ),
            array( array( 'position' => new utility\validator\NumberValidator( 'position', 'slier' ) ), array( 'position' => 'Field position contains error.Only numbers without decimal places are allowed' ) ),
            array( array( 'position' => new utility\validator\NumberValidator( 'position', 'slier' ), 'user' => new utility\validator\TextValidator( 'user', '123' ) ), array( 'position' => 'Field position contains error.Only numbers without decimal places are allowed', 'user' => 'Field user contains error.Only text are allowed' ) )
        );
    }
    ...
    public function dataProvidertestShowErrorReturnsExpectedValue()
    {
        ...
        return array(
            ...
            array( array( 'user' => new utility\validator\TextValidator( 'user', '123' ) ), 'Field user contains error.Only text are allowed<br>' ),
            array( array( 'position' => new utility\validator\NumberValidator( 'position', 'slier' ) ), 'Field position contains error.Only numbers without decimal places are allowed<br>' ),
            array( array( 'position' => new utility\validator\NumberValidator( 'position', 'slier' ), 'user' => new utility\validator\TextValidator( 'user', '123' ) ), 'Field position contains error.Only numbers without decimal places are allowed<br>Field user contains error.Only text are allowed<br>' )
