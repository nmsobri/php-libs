...
class FormTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $mock_form = $this->getMockBuilder( 'utility\Form' )->setMethods( array( 'getFormData' ) )->getMock();
    ...
    public function dataProvidertestGetFormDataReturnsExpectedValue()
    {
        ...
        return array(
            ...
            array( new utility\Form(), array( 'method' => 'post' ) ),
            array( new utility\Form( 'post' ), array( 'method' => 'post' ) ),
            array( new utility\Form( 'get' ), array( 'method' => 'get' ) )
